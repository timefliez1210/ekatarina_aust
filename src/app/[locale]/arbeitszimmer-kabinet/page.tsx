...
export default async function OfficePage({
    ...
    const content = {
        ru: {
            ...
            description: 'высота потолков позволила добавить консольный этаж. Внизу – деловой ритм, работа, переговоры. Наверху – тишина, книги и личное время. Стиль интерьера – классика с современными акцентами: темные детали, строгие линии и сдержанная палитра. Центральный элемент кабинета – винтовая лестница, из матового металла с «мятой» фактурой. Она объединяет два уровня и задает характер пространства, контрастируя с классическим Interior Design.',
            galleryText: 'Планировочное решение этой концепции разработано с максимальной пользой – высота потолков позволила добавить консольный этаж. Внизу – деловой ритм, работа, переговоры. Наверху – тишина, книги и личное время. Стиль интерьера – классика с современными акцентами: темные детали, строгие линии и сдержанная палитра. Центральный элемент кабинета – винтовая лестница, из матового металла с «мятой» фактурой. Она объединяет два уровня и задает характер пространства, контрастируя с классическим Interior Design.',
